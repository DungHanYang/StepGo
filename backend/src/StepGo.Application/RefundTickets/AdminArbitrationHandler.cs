...
public sealed class AdminArbitrationHandler(IRefundTicketRepository ticketRepository, RefundApprovalFinalizer finalizer, StepGo.Application.Common.IClock clock)
{
