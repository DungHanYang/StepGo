...
public sealed class RefundTicket : AggregateRoot<Guid>
{
    ...
    public StepGo.Orders.Domain.RefundRoute? RefundExecutionRoute { get; private set; }
    ...
    public static RefundTicket Rehydrate(
        ...
        Money? decidedAmount, DeductionSource? decidedDeductionSource, StepGo.Orders.Domain.RefundRoute? refundExecutionRoute,
    ...
    public void SetRefundExecutionRoute(StepGo.Orders.Domain.RefundRoute route) => RefundExecutionRoute = route;
    ...
    {
        if (RefundExecutionRoute != StepGo.Orders.Domain.RefundRoute.ManualBankTransferPending)
        {
