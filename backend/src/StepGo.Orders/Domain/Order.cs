...
public sealed class Order : AggregateRoot<Guid>
{
    ...
    /// The fee breakdown is computed by StepGo.Shared.Domain.FeeLedger.FeeCalculationResult against the rate
    /// schedule version in effect right now and persisted on the order permanently (fee-schedule version binding).
    /// </summary>
    public void ConfirmPayment(PaymentMethod methodUsed, StepGo.Shared.Domain.FeeLedger.FeeCalculationResult fees, DateTimeOffset now)
    {
