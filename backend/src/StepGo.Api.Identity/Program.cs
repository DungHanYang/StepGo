...
static Role MapRole(RoleDto role) => role switch
{
...
static RoleDto MapRoleDto(Role role) => role switch
{
...
static TeacherVerificationDto ToDto(TeacherProfile profile) => new(
